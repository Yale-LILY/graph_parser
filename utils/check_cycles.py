...
if __name__ == '__main__':
    ...
    #input_file = '/data/lily/jk964/active_projects/ud/graph_parser/data/tag_wsj/predicted_arcs_greedy/test.txt'
    predicted_arcs = read_sents(input_file)
    for sent_idx in xrange(len(predicted_arcs)):
        predictions = np.array([0] + map(int, predicted_arcs[sent_idx]))
